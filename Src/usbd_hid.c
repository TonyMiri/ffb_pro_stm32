/**
  ******************************************************************************
  * @file    usbd_hid.c
  * @brief   HID joystick + force feedback implementation
  ******************************************************************************
  */
...
#define HID_MOUSE_REPORT_DESC_SIZE    185 
...
{
    // Report ID 1: Joystick Input
    0x05, 0x01,         // Usage Page (Generic Desktop)
    0x09, 0x04,         // Usage (Joystick)
    0xA1, 0x01,         // Collection (Application)
    
    // Declare force feedback capabilities
    0x85, 0x01,         // Report ID (1)
    0x09, 0x01,         // Usage (Pointer)
    0xA1, 0x00,         // Collection (Physical)
    
    // X and Y axes with proper ranges
    0x09, 0x30,         // Usage (X)
    0x09, 0x31,         // Usage (Y)
